...
def print_confusion_matrix(figsize = (40,28), fontsize=12):
    ...
    r = pickle.load(open("aircraft_test_result.pkl", "r"))
    y_true = r["gt_labels"]
    y_pred = r["predicts"]
